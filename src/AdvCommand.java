...
/**
 * This class is the general superclass for all commands in the Adventure game. Every command has an
 * execute method, which is called by the game when that command is invoked. This method will be
 * defined individually in each of the subclasses.
 */
...
public abstract class AdvCommand {
  ...
  /**
   * Executes this command in the context of the specified adventure game. The execute method also
   * takes a parameter obj, which specifies the object being used in the command. This value is
   * typically null, but will be the appropriate object in the case of the TAKE and DROP commands.
   *
